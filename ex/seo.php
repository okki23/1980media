  ...
  <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-3 col-sm-push-7 text-center">
          <img src="img/SEO.png" alt="Apa itu Search Engine Optimization (SEO)?" >
        </div>
  ...
  <div id="sem" class="container-fluid bg-grey bg-center">
      <div class="row">
        ...
        <div class="col-sm-3 col-md-4 col-lg-3">
          <img src="img/SEM.png" alt="Apa itu Search Engine Optimization (SEO)?" class="img-responsive">
        </div>
