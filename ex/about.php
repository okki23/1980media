...
<head>
  ...
  <link rel="icon" href="img/logo1980.png" type="image/png" sizes="16x16">
...
<body>
	...
	<div class="container-fluid text-center middle">
      ...
      <div class="col-sm-2 col-md-2"><img src="img/about/consultant.png"><h5>CONSULTING</h5></div>
			<div class="col-sm-2 col-md-2"><img src="img/about/research.png"><h5>RESEARCH</h5></div>
			<div class="col-sm-2 col-md-2"><img src="img/about/solution.png"><h5>CONSULTING</h5></div>
			<div class="col-sm-2 col-md-2"><img src="img/about/strategy.png"><h5>STRATEGY</h5></div>
      <div class="col-sm-2 col-md-2"></div>
		</div>
	</div>
