    ...
    <div class="container-fluid">
      ...
      <div id="navbar" class="navbar-collapse collapse">
        <ul class="nav navbar-nav custom_nav">
          ...
          <li class=""><a href="<?php echo base_url('home'); ?>"> <i class="fa fa-home fa-fw" aria-hidden="true"></i>  &nbsp; Beranda</a></li>
...
<section id="mainContent">
  ...
  <div class="content_bottom">
  	<div align="right">
  	 <a href="<?php echo base_url('webmail'); ?>" class="btn btn-danger"> <i class="fa fa-envelope fa-fw" aria-hidden="true"></i> &nbsp; Login E-Mail</a> 
    ...
    <div class="content_bottom_right">
        ...
        <div class="single_bottom_rightbar">
          ...
          <div id="sfcu34uthclucuwbqdg1hpdunb1tspw66ws"></div><script type="text/javascript" src="https://counter8.freecounter.ovh/private/counter.js?c=u34uthclucuwbqdg1hpdunb1tspw66ws&down=async" async></script><noscript><a href="https://www.freecounterstat.com" title="free page counter"><img src="https://counter8.freecounter.ovh/private/freecounterstat.php?c=u34uthclucuwbqdg1hpdunb1tspw66ws" border="0" title="free page counter" alt="free page counter"></a></noscript>
           
        </div>
        <br>
         <div class="single_bottom_rightbar">
          <h2>Waktu Dan Cuaca</h2>
