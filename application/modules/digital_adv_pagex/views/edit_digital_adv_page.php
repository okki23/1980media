...
<h1 align="center"> Digital Advertising Form    </h1>
<form action="<?php echo base_url('digital_adv_page/save') ;?>" method="POST">
		<div class="col-md-12">
				...
				<div  align="center">
                    ...
                    <a class="btn btn-danger" href="<?php echo base_url('digital_adv_page'); ?>"> <i class="fa fa-reply-all"></i> Back </a>
                </div>
				<br>
				<br>
				<br>				 
