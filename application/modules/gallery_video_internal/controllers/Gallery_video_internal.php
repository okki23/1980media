...
class Gallery_video_internal extends MY_Controller {
    ...
    public function __construct(){
		parent ::__construct();
		$this->load->model('m_gallery_video_internal','ma');
	}
	public function index()
	{
        $data['content'] = 'gallery_video_internal/view_gallery_video_internal'; 
		$data['title'] = $this->data['meta_title'];
        //session
        $data['list'] = $this->ma->get($this->tablename,$this->pk)->result();
        //var_dump($data['gallery_video_internal']);
	...
	public function edit($id = NULL) {
        $data['content'] = 'gallery_video_internal/edit_gallery_video_internal'; 
		$data['title'] = $this->data['meta_title'];       
	...
	public function delete() {
        ...
        redirect(base_url('gallery_video_internal'));
    }
