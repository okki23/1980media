...
<div class="row">
<div class="col-md-12"> 
<form action="<?php echo base_url('gallery_foto/save') ;?>" method="POST">
		<div class="col-md-12">
			 ...
			 <div id="elfinder-tag" style="height: 90%; border: 0px;  padding: 0px 0px 90px 0px;" ></div>
				...
				<div  align="center">
                    ...
                    <a class="btn btn-danger" href="<?php echo base_url('gallery_foto'); ?>"> <i class="fa fa-reply-all"></i> Back </a>
                </div>
				<br>
				<br>
				<br>				 
