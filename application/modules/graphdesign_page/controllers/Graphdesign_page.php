...
class Graphdesign_page extends MY_Controller {
    
    var $parsing_form_input = array('id','konten','last_update');
    var $tablename = 'page_graph_design';
    var $pk = 'id';
    

    public function __construct(){
		parent ::__construct();
		$this->load->model('m_graphdesign_page','ma');
	}
	public function index()
	{
        $data['content'] = 'graphdesign_page/view_graphdesign_page'; 
		$data['title'] = $this->data['meta_title'];
        //session
        $data['list'] = $this->ma->get($this->tablename,$this->pk)->result();
        //var_dump($data['graphdesign_page']);
	...
	public function edit($id = NULL) {
        $data['content'] = 'graphdesign_page/edit_graphdesign_page'; 
		$data['title'] = $this->data['meta_title'];       
	...
	public function delete() {
        ...
        if($sql){
            echo "<script language=javascript>
             ...
             window.location='" . base_url('graphdesign_page') . "';
                 </script>";
          }
    }
