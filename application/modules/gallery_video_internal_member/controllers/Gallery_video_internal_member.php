...
class gallery_video_internal_member extends MY_Controller {
    
    var $parsing_form_input = array('id','caption','video');
    var $tablename = 'page_video_internal';
    var $pk = 'id';
    
    public function __construct(){
		parent ::__construct();
		$this->load->model('m_gallery_video_internal_member','ma');
	}
	public function index()
	{
        $data['content'] = 'gallery_video_internal_member/view_gallery_video_internal_member'; 
        ...
        $jumlah_data = $this->ma->jumlah_data();
        //$data['list'] = $this->ma->get($this->tablename,$this->pk)->result();
        $this->load->library('pagination');	
        
                $config['base_url'] = base_url().'gallery_video_internal_member/index/';
                ...
                $data['list'] = $this->ma->data($config['per_page'],$from);
        
        //var_dump($data['gallery_video_internal_member']);
	...
	public function edit($id = NULL) {
        $data['content'] = 'gallery_video_internal_member/edit_gallery_video_internal_member'; 
		$data['title'] = $this->data['meta_title'];       
	...
	public function delete() {
        ...
        redirect(base_url('gallery_video_internal_member'));
    }
