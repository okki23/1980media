...
<h1 align="center"> Services Form    </h1>
<form action="<?php echo base_url('services_page/save') ;?>" method="POST">
		<div class="col-md-12">
				...
				<div  align="center">
                    ...
                    <a class="btn btn-danger" href="<?php echo base_url('services_page'); ?>"> <i class="fa fa-reply-all"></i> Back </a>
                </div>
				<br>
				<br>
				<br>				 
