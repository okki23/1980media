...
class upload_neraca_member extends MY_Controller {
    ...
    public function __construct(){
		parent ::__construct();
		$this->load->model('m_upload_neraca_member','ma');
	}
	public function index()
	{
        $data['content'] = 'upload_neraca_member/view_upload_neraca_member'; 
		$data['title'] = $this->data['meta_title'];
        //session
        $data['upload_neraca_member'] = $this->ma->get($this->tablename,$this->pk)->result();
        //var_dump($data['upload_neraca_member']);
	...
	public function edit($id = NULL) {
        $data['content'] = 'upload_neraca_member/edit_upload_neraca_member'; 
		$data['title'] = $this->data['meta_title'];       
        if($id == '' || empty($id) || $id == NULL){
            $data['upload_neraca_member'] = $this->ma->get_new($this->parsing_form_input);
        }else{
            $data['upload_neraca_member'] = $this->ma->get($this->tablename,$this->pk,$id)->row();
        }
        //session
        $data['username'] = $this->session->userdata('username');
        $data['user_group'] = strtoupper(level_help($this->session->userdata('user_group')));
	...
	public function delete() {
        ...
        redirect(base_url('upload_neraca_member'));
    }
