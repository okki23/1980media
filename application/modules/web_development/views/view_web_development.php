...
<header  class="jumbotron">
   <img src="<?php echo base_url(); ?>images/web_development_SEM.jpg" />
</header>
  <div class="container-fluid">
      <div class="row">
        <h3 class="title"><u>Apa itu Search Engine Optimization (web_development)?</u></h3>
        <div class="col-sm-1 text-center"></div>
        <div class="col-sm-3 col-sm-push-7 text-center">
          <img src="<?php echo base_url(); ?>images/web_development.png" alt="Apa itu Search Engine Optimization (web_development)?" >
        </div>
        <div class="col-sm-7 col-sm-pull-3">
          <p>Search Engine Optimization (web_development) adalah proses peningkatan rangking dan visibilitas website / brand anda di search engine. Mesin pencari seperti Google akan menampilkan hasil organik berdasarkan kata kunci pencarian dan listing di Google yang gratis.</p>
          <p><strong>Mengapa web_development?</strong></p>
          ...
          <p>1980media memahami bahwa optimasi web_development adalah investasi jangka panjang untuk klien kami. Oleh karena itu, kami hanya memanfaatkan teknik white-hat web_development Indonesia dan benar-benar mematuhi pedoman kualitas mesin pencari, sebagai bagian dari due diligence kami.</p>
        </div>
  ...
  <div id="sem" class="container-fluid bg-grey bg-center">
      <div class="row">
        ...
        <div class="col-sm-3 col-md-4 col-lg-3">
          <img src="<?php echo base_url(); ?>images/SEM.png" alt="Apa itu Search Engine Optimization (web_development)?" class="img-responsive">
        </div>
