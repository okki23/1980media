...
class Email_subscribe extends MY_Controller {
    
    var $parsing_form_input = array('id','nama_akun','nama_email');
    var $tablename = 'email_subscribe';
    var $pk = 'id';
    

    public function __construct(){
		parent ::__construct();
        $this->load->model('m_email_subscribe','ma');
	...
	{
        $data['content'] = 'email_subscribe/view_email_subscribe'; 
		$data['title'] = $this->data['meta_title'];
        //session
        $data['list'] = $this->ma->get($this->tablename,$this->pk)->result();
        //var_dump($data['email_subscribe']);
	...
	public function edit($id = NULL) {
        $data['content'] = 'email_subscribe/edit_email_subscribe'; 
		$data['title'] = $this->data['meta_title'];       
	...
	public function delete() {
        ...
        if($sql){
            echo "<script language=javascript>
             ...
             window.location='" . base_url('email_subscribe') . "';
                 </script>";
          }
    }
