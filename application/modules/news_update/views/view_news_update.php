                   ...
                   <?php
						 foreach($content as $k => $v){
							 ...
							 <div class="blog-post-image" align="center">
								 <a href="'.base_url('news_update/detail_news/').$v->id.'"><img src="'.base_url('uploads/'.$v->picture_news).'" alt="" style="width:750px; height:500px;"></a>
							 </div>
							 <div class="blog-post-body">
								 <h2><a href="'.base_url('news_update/detail_news/').$v->id.'">'.$v->title_news.'</a></h2>
								 <div class="post-meta"><span> Diposkan Oleh  '.$v->user_update_news.' </span> Pada<span><i class="fa fa-clock-o"></i> '.tanggalan($v->update_news).'</span>  </div>
								 <p>'.substr($v->desc_news,0,150).' .... </p>
								 <div class="read-more"><a href="'.base_url('news_update/detail_news/').$v->id.'">Continue Reading</a></div>
							 </div>
						 </article>
						 ';
						 }
					...
					<?php 
						...
						echo "<p style='font-size:20px;'>".$this->pagination->create_links()."</p>";
