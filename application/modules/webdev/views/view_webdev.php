...
<?php echo $this->load->view('header'); ?>
  ...
  <div class="container-fluid">
      <div class="row">
        <h3 class="title"><u>Apa itu webdev Design ?</u></h3>
        <div class="col-md-1 col-sm-1"></div>
        <div class="col-md-10 col-sm-10">
          <h4><strong>Increase Brand Image with webdev Design</strong></h4>
          <br />
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-12">
              ...
              <input type="hidden" class="form-control"  name="source" type="text" value="webdev">
                <div class="row">
                  <div class="col-md-6">
