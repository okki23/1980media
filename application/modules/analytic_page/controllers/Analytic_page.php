...
class analytic_page extends MY_Controller {
    
    var $parsing_form_input = array('id','konten','last_update');
    var $tablename = 'page_analytic';
    var $pk = 'id';
    

    public function __construct(){
		parent ::__construct();
		$this->load->model('m_analytic_page','ma');
	}
	public function index()
	{
        $data['content'] = 'analytic_page/view_analytic_page'; 
		$data['title'] = $this->data['meta_title'];
        //session
        $data['list'] = $this->ma->get($this->tablename,$this->pk)->result();
        //var_dump($data['analytic_page']);
	...
	public function edit($id = NULL) {
        $data['content'] = 'analytic_page/edit_analytic_page'; 
		$data['title'] = $this->data['meta_title'];       
	...
	public function delete() {
        ...
        if($sql){
            echo "<script language=javascript>
             ...
             window.location='" . base_url('analytic_page') . "';
                 </script>";
          }
    }
