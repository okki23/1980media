...
class Email_subscriber extends MY_Controller {
    
    var $parsing_form_input = array('id','nama_akun','nama_email');
    var $tablename = 'email_subscriber';
    var $pk = 'id';
    

    public function __construct(){
		parent ::__construct();
		$this->load->model('m_email_subscriber','ma');
	}
	public function index()
	{
        $data['content'] = 'email_subscriber/view_email_subscriber'; 
		$data['title'] = $this->data['meta_title'];
        //session
        $data['list'] = $this->ma->get($this->tablename,$this->pk)->result();
        //var_dump($data['email_subscriber']);
	...
	public function edit($id = NULL) {
        $data['content'] = 'email_subscriber/edit_email_subscriber'; 
		$data['title'] = $this->data['meta_title'];       
	...
	public function delete() {
        ...
        if($sql){
            echo "<script language=javascript>
             ...
             window.location='" . base_url('email_subscriber') . "';
                 </script>";
          }
    }
