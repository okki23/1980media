...
//   var $tablename = 'm_dashboard';

    public function __construct() {
        parent::__construct();
        $this->load->model('m_dashboard','m_empp');
    ...
    public function get_bawahan_foreman($idforeman) {
        ...
        $data['iddashboard'] = $this->session->userdata('iddashboard');
    ...
    public function add() {
        ...
        $data['opt_dashboard'] = $this->model_user_management->opt_dashboard();
    ...
    public function get_val_peg() {
        ...
        $data = $this->db->get('tb_dashboard')->row();
    ...
    public function cetak() {
        ...
        ob_end_clean();
        //$this->pdf->Output("dashboard Information.pdf", "I");
