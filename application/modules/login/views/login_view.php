...
<html lang="en">
	<head>
		...
		<!--[if lte IE 9]>
			<link rel="stylesheet" href="<?php echo base_url(); ?>assets/backend/css/ace-part2.min.css" />
		<![endif]-->
						...
						<div class="login-container">
							<div class="center">
								<h1>
									...
									<span class="white" id="id-text2">Media</span>
								</h1>
								<h4 class="blue" id="id-company-text">Administrator</h4>
							</div>
