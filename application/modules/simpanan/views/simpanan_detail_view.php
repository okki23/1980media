...
function getupdate(a,b){
  ...
  function closemodal(){
      ...
      $("input[name='path_upload']").val('');
      $("input[name='path_uploadx']").val('');
    }
...
<td> <?php echo "<a target='_blank' href=".base_url('uploads/'.str_replace(" ","_",$val->path_upload)).">".$val->path_upload." <span class='glyphicon glyphicon-cloud-download' aria-hidden='true'> </span>  </a>"; ?> </td>
<td> <a href="javascript:void(0);" onClick='getupdate(<?php echo $val->id; ?>,<?php echo $this->uri->segment(3); ?>);'> Edit </a> &nbsp;
     <a href="<?php echo base_url('simpanan/simpanan_detail_delete/'.$val->id.'/'.$this->uri->segment(3))?>" > Delete </a>
</td>
</tr> 
<?php
$no++;
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form action="<?php echo base_url('simpanan/simpanan_detail_save'); ?>"  method="POST" enctype="multipart/form-data"> 
        <input type="hidden" name="id" id="idform">
        <input type="hidden" name="idsimpan" value="<?php echo $id; ?>">
        <input type="hidden" name="id_anggota" id="idformanggota" value="<?php echo $this->uri->segment(3); ?>">
 ...
 Upload Bukti : <input type="hidden" name="path_upload" id="path_upload"  >
