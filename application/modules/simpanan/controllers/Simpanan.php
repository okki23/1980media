...
class Simpanan extends MY_Controller {
  ...
  var $parsing_form_input = array('id','id_anggota','jumlah_bayar','tanggal_bayar','status','path_upload');
  var $tablename = 't_simpanan';
    ...
    public function index() {
        ...
        //$data['sum'] = $this->m_sup->all_records();
    ...
    public function rekap() {
        ...
        header("Content-Transfer-Encoding: binary ");
         ...
         $data = $this->db->query("select a.id,b.id_anggota,a.nama_asli,b.tanggal_bayar,b.status,b.jumlah_bayar,sum(b.jumlah_bayar) as summary from m_anggota a
		...
		GROUP BY a.id")->result();
         ...
         foreach($data as $key=>$val){
            ...
            echo '<td> Rp. '.number_format($val->summary,"0").'</td>';
    ...
    public function simpanan_detail_delete(){
        ...
        if($qry){
            ...
            window.location='" . base_url('simpanan/simpanan_detail_view/'.$id_anggota) . "';
                </script>";
        }
    }
           ...
           if($savesimpan){
            ...
            if($saveupdate){
                echo "<script language=javascript>
                 ...
                 window.location='" . base_url('simpanan/simpanan_detail_view/'.$datapos['id_anggota']) . "';
                     </script>";
            }   
        }
