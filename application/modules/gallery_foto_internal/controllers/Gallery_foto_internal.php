...
class Gallery_foto_internal extends MY_Controller {
    ...
    public function __construct(){
		parent ::__construct();
		$this->load->model('m_gallery_foto_internal','ma');
	}
	public function index()
	{
        $data['content'] = 'gallery_foto_internal/view_gallery_foto_internal'; 
	...
	public function edit($id = NULL) {
        $data['content'] = 'gallery_foto_internal/edit_gallery_foto_internal'; 
		$data['title'] = $this->data['meta_title'];       
	...
	public function delete() {
        ...
        redirect(base_url('gallery_foto_internal'));
    }
