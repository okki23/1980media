...
<h1 align="center"> Homepage Form    </h1>
<form action="<?php echo base_url('homepage/save') ;?>" method="POST">
		<div class="col-md-12">
				...
				<div  align="center">
                    ...
                    <a class="btn btn-danger" href="<?php echo base_url('homepage'); ?>"> <i class="fa fa-reply-all"></i> Back </a>
                </div>
				<br>
				<br>
				<br>				 
